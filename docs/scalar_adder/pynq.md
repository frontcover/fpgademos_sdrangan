...
* On the host PC connected to the FPGA, open the notebook at `/hwdesign/scalar_adder/scalar_adder.ipynb`.
* The notebook is also at the [github page](https://github.com/sdrangan/hwdesign/tree/main/scalar_adder/notebooks/scalar_adder.ipynb)
