...
#
# project_recreate.tcl: Tcl script for re-creating project 'scalar_add_vivado'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../../scalar_add_vitis/add/hls/impl/ip"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "scalar_add_vivado"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../scalar_add_vitis/add/hls/impl/ip"]" $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../scalar_add_vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
